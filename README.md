...
The persona data used by this app isn't hand-written — it's generated by a dedicated data preparation pipeline. For a deep dive into:

* **How the persona data was collected and prepared** — YouTube transcript ingestion, batching, and behavioural extraction
* **Prompt engineering strategy** — the multi-stage `BATCH_ANALYSIS_PROMPT` → `MERGE_PERSONA_PROMPT` → `FEW_SHOTS_PROMPT` design
* **Context management approach** — how transcripts are synthesized into a stable persona spec and few-shot set without blowing up context size

see the **[`transcript-generator` repository README](https://github.com/arunava2018/transcript-generator-Persona-AI)**.
...
└── transcript-generator/  # Pipeline for generating persona data from transcripts
                            # → see https://github.com/arunava2018/transcript-generator-Persona-AI
```
...
> ℹ️ These asset files are generated by the [`transcript-generator` pipeline](https://github.com/arunava2018/transcript-generator-Persona-AI) — see that repo's README for the full data-collection and prompt-engineering documentation.
...
📚 Data pipeline documentation: [transcript-generator-Persona-AI](https://github.com/arunava2018/transcript-generator-Persona-AI)
